...
FROM ( SELECT *, SUBSTR(misspelled_word,1,2) AS mf1, SUBSTR(misspelled_word,2,2) AS mf2, 
      		...
      		SUBSTR(REVERSE(misspelled_word),6,2) AS mr7, SUBSTR(REVERSE(misspelled_word),8,2) AS mr8
	FROM word
	HAVING @word SOUNDS LIKE misspelled_word OR
		SUBSTR(@word,1,2) IN (mf1, mf2, mf3, mf4, mf5, mf6, mf7,mf8) OR
		SUBSTR(@word,2,2) IN (mf1, mf2, mf3, mf4, mf5, mf6, mf7,mf8) OR
		SUBSTR(@word,3,2) IN (mf1, mf2, mf3, mf4, mf5, mf6, mf7,mf8) OR
		SUBSTR(@word,4,2) IN (mf1, mf2, mf3, mf4, mf5, mf6, mf7,mf8) OR
		SUBSTR(@word,6,2) IN (mf1, mf2, mf3, mf4, mf5, mf6, mf7,mf8) OR
		SUBSTR(@word,7,2) IN (mf1, mf2, mf3, mf4, mf5, mf6, mf7,mf8) OR
      		SUBSTR(@word,8,2) IN (mf1, mf2, mf3, mf4, mf5, mf6, mf7,mf8) OR
      		SUBSTR(REVERSE(@word),1,2) IN (mr1, mr2, mr3, mr4, mr5, mr6, mr7, mr8) OR
      		SUBSTR(REVERSE(@word),2,2) IN (mr1, mr2, mr3, mr4, mr5, mr6, mr7, mr8) OR 	
		SUBSTR(REVERSE(@word),3,2) IN (mr1, mr2, mr3, mr4, mr5, mr6, mr7, mr8) OR
		SUBSTR(REVERSE(@word),4,2) IN (mr1, mr2, mr3, mr4, mr5, mr6, mr7, mr8) OR
		SUBSTR(REVERSE(@word),5,2) IN (mr1, mr2, mr3, mr4, mr5, mr6, mr7, mr8) OR
		SUBSTR(REVERSE(@word),6,2) IN (mr1, mr2, mr3, mr4, mr5, mr6, mr7, mr8) OR
		SUBSTR(REVERSE(@word),7,2) IN (mr1, mr2, mr3, mr4, mr5, mr6, mr7, mr8) OR
      		SUBSTR(REVERSE(@word),8,2) IN (mr1, mr2, mr3, mr4, mr5, mr6, mr7, mr8)
	 ) AS t 
